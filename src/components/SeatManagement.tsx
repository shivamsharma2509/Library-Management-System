        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center">
          ...
          <div className="flex space-x-4">
            <div className="flex flex-col space-y-1">
              {Array.from({ length: 21 }, (_, i) => renderSeat(77 + i))}
            </div>
            <div className="flex flex-col space-y-1">
              {Array.from({ length: 26 }, (_, i) => renderSeat(76 - i))}
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            {/* Block 1: 1–9 */}
            <div className="flex space-x-1">{Array.from({ length: 9 }, (_, i) => renderSeat(i + 1))}</div>

            {/* Block 2: 10–15, 16–19 */}
            <div className="flex flex-col space-y-1">
              <div className="flex space-x-1">{Array.from({ length: 6 }, (_, i) => renderSeat(i + 10))}</div>
              <div className="flex space-x-1">{Array.from({ length: 4 }, (_, i) => renderSeat(i + 16))}</div>
            </div>

            {/* Block 3: 20–23, 24–30 */}
            <div className="flex flex-col space-y-1">
              <div className="flex space-x-1">{Array.from({ length: 4 }, (_, i) => renderSeat(i + 20))}</div>
              <div className="flex space-x-1">{Array.from({ length: 7 }, (_, i) => renderSeat(i + 24))}</div>
            </div>

            {/* Block 4: 31–32 */}
            <div className="flex space-x-1">{renderSeat(31)} {renderSeat(32)}</div>

            {/* Block 5: 33–50 */}
            <div className="grid grid-cols-3 gap-1">
              {Array.from({ length: 18 }, (_, i) => renderSeat(i + 33))}
            </div>

            {/* Extra Block: 98–102 */}
            <div className="flex space-x-1">{Array.from({ length: 5 }, (_, i) => renderSeat(i + 98))}</div>
          </div>
        </div>
      </div>
